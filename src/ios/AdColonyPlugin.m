...
- (void) setUp: (CDVInvokedUrlCommand*)command {
    ...
    NSString* interstitialAdZoneId = [command.arguments objectAtIndex:2];
    NSString* rewardedVideoAdZoneId = [command.arguments objectAtIndex:3];
    NSLog(@"%@", advertisingId);
    NSLog(@"%@", appId);
    ...
    //[self.commandDelegate runInBackground:^{
    [self _setUpWithAdvertisingId:advertisingId andAppId:appId aInterstitialAdZoneId:interstitialAdZoneId aRewardedVideoAdZoneId:rewardedVideoAdZoneId];
    //}];
}
...
- (void) _setUpWithAdvertisingId:(NSString *)advertisingId andAppId:(NSString *)appId aInterstitialAdZoneId:(NSString *)interstitialAdZoneId aRewardedVideoAdZoneId:(NSString *)rewardedVideoAdZoneId {
