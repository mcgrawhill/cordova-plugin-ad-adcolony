...
public class AdColonyPlugin extends CordovaPlugin {
    ...
    private void setUp(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        final String advertisingId = args.getString(0);
        final String appId = args.getString(1);
        final String interstitialAdZoneId = args.getString(2);
        final String rewardedVideoAdZoneId = args.getString(3);
        Log.d(LOG_TAG, String.format("advertisingId - %s", advertisingId));
        Log.d(LOG_TAG, String.format("appId - %s", appId));
        Log.d(LOG_TAG, String.format("interstitialAdZoneId - %s", interstitialAdZoneId));
        Log.d(LOG_TAG, String.format("rewardedVideoAdZoneId - %s", rewardedVideoAdZoneId));
        ...
        cordova.getActivity().runOnUiThread(new Runnable() {
            @Override
            public void run() {
                _setUp(advertisingId, appId, interstitialAdZoneId, rewardedVideoAdZoneId);
            }
        });
    }
    ...
    private void _setUp(String advertisingId, String appId, String interstitialAdZoneId, String rewardedVideoAdZoneId) {
        this.appId = appId;
        ...
        optionString = "userid:" + advertisingId;
...
//		}
        ...
        AdColony.setDeviceID(advertisingId);
        AdColony.setCustomID(advertisingId);
